...
LEFT_EYE_LANDMARKS = [133, 159, 33, 23]

RIGHT_EYE_LANDMARKS = [362, 386, 263, 253]
...
#Features nécessaires pour l'implémentation de l'article Webcam-Based Visual Gaze Estimation
        ...
        self.is_predicting_with_article = True
#####################################################################################
    ...
    def compute_eyeball_position_from_landmarks(self):
        ...
        self.left_eyeball_3D = left_eye_center_3D - EYE_RADIUS_MM * left_normal_vector
        self.right_eyeball_3D = right_eye_center_3D - EYE_RADIUS_MM * right_normal_vector
    ...
    def get_screen_coordinates(self):
        if self.is_predicting_with_article:
    ...
    def update(self):
        ...
        if self.is_eyeball_ref_saved:
            ...
            self.compute_eyeball_position_from_landmarks()
